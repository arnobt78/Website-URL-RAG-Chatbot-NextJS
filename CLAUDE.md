...
| Current Status | **REQ-0010 + Phase 3 UX** — monotonic batch crawl/index progress via offsets + `crawlProgressDisplay`; batched embedding; re-crawl clears `ingestError`; lint/test/build PASS (69 + 1 skipped) |
